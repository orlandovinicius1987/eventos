...
class Import extends Controller
{
    ...
    private function importAdvisor($row, $personInstitution)
    {
        ...
        collect([
            ['contact' => $row->assessor_telefone ?? null, 'type' => 'mobile'],
            ['contact' => $row->assessor_telefone1 ?? null, 'type' => 'mobile'],
            ['contact' => $row->assessor_telefone2 ?? null, 'type' => 'mobile'],
            ['contact' => $row->assessor_telefone3 ?? null, 'type' => 'mobile'],
