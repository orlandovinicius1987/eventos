    ...
    'notifications' => [
        ...
        'message' => [
            ...
            'request_count' => [
                ...
                'message' =>
                    'Received %s requests in the last %s seconds. Timestamp of first request: %s',
            ],
        ...
        'channels' => [
            'slack' => [
                'enabled' => true,
                'sender' =>
                    PragmaRX\Firewall\Notifications\Channels\Slack::class,
            ],

            'mail' => [
                'enabled' => true,
                'sender' =>
                    PragmaRX\Firewall\Notifications\Channels\Mail::class,
            ],
        ],
    ],
];
