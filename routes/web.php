...
Route::group(
    ...
    function () {
        ...
        Route::group(
            ...
            function () {
                Route::get('zipcode/{zipcode}', 'ZipCode@get')->name(
                    'api.zipcode.get'
                );
                ...
                Route::group(['middleware' => 'auth'], function () {
                    Route::group(['prefix' => '/sub-events'], function () {
                        Route::get(
                            '/',
                            'SubEvents@associateableSubEvent'
                        )->name('sub-events.associateableSubEvent');
                    ...
                    Route::group(['prefix' => '/events'], function () {
                        Route::get(
                            '/',
                            'Events@allHasSubEventsNotFinalized'
                        )->name('events.all');
                        ...
                        Route::post('/{id}', 'Events@update')->name(
                            'events.update'
                        );

                        Route::group(
                            ['prefix' => '{eventId}/sub-events'],
                            function () {
                                Route::get('/', 'SubEvents@all')->name(
                                    'sub-events.all'
                                );
                                ...
                                Route::post(
                                    '/{id}/confirm',
                                    'SubEvents@confirm'
                                )->name('sub-events.confirm');

                                Route::post(
                                    '/{id}/finalize',
                                    'SubEvents@finalize'
                                )->name('sub-events.finalize');

                                Route::get(
                                    '/{id}/download',
                                    'SubEvents@download'
                                )->name('sub-events.download');
                    ...
                    Route::group(['prefix' => '/people'], function () {
                        ...
                        Route::post(
                            '/validate-name',
                            'People@validateName'
                        )->name('people.validate-name');

                        Route::get('/{id}/photo', 'People@photo')->name(
                            'people.photo'
                        );
                        ...
                        Route::get(
                            '/{id}/phone-book',
                            'People@phoneBook'
                        )->name('people.phone-book');

                        Route::post('/', 'People@store')->name('people.store');

                        Route::post('/{id}', 'People@update')->name(
                            'people.update'
                        );
                        ...
                        Route::group(
                            ...
                            function () {
                                Route::get(
                                    '/',
                                    'PersonInstitutions@allByPerson'
                                )->name('person-institutions.all-by-person');

                                Route::post(
                                    '/',
                                    'PersonInstitutions@store'
                                )->name('person-institutions.store');

                                Route::post(
                                    '/{id}',
                                    'PersonInstitutions@update'
                                )->name('person-institutions.update');

                                Route::group(
                                    [
                                        'prefix' =>
                                            '{personInstitutionId}/contacts',
                                    ],
                                    function () {
                                        Route::get(
                                            '/',
                                ...
                                Route::group(
                                    ...
                                    function () {
                                        ...
                                        Route::post(
                                            ...
                                            'person-institutions-addresses.update'
                                        );
                                    }
                                );
                            }
                    ...
                    Route::group(['prefix' => '/roles'], function () {
                        ...
                        Route::post('/{id}', 'Roles@update')->name(
                            'roles.update'
                        );
                    ...
                    Route::group(['prefix' => '/categories'], function () {
                        ...
                        Route::post('/', 'Categories@store')->name(
                            'categories.store'
                        );
                    });

                    Route::group(['prefix' => '/institutions'], function () {
                        Route::get('/', 'Institutions@all')->name(
                            'institutions.all'
                        );
                    ...
                    Route::group(['prefix' => '/contact-types'], function () {
                        Route::get('/', 'ContactTypes@all')->name(
                            'contactTypes.all'
                        );
                    ...
                    Route::post('/import', 'Import@store')->name(
                        'import.store'
                    );
            ...
            function () {
                ...
                Route::group(
                    ...
                    function () {
                        Route::get(
                            '/{uuid}/qrcode',
                            'Invitations@showViaQRCode'
                        )->name('invitations.show-via-qrcode');
                    }
                );
