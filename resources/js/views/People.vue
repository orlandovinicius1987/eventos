            ...
            <div class="col-8">
                <div class="row">
                    ...
                    <div class="col-12">
                        <app-table-panel
                                v-if="selected.id && personInstitutions.data.links"
                                :title="'Funções: ' + personInstitutions.data.links.pagination.total"
                    ...
                    <div class="col-12">
                        <app-table-panel
                                ...
                                :title="'Contatos: ' + contacts.data.links.pagination.total"
                    ...
                    <div class="col-12">
                        <app-table-panel
                                ...
                                :title="'Endereços: ' + addresses.data.links.pagination.total"
