...
var render = function() {
  ...
  return _c("div", [
    _c("div", { staticClass: "py-2 text-center" }, [
      _c("h2", [
        _vm._v(
          _vm._s(this.mode === "create" ? "Nova " : "Editar ") + "Instituição"
        )
      ]),
      _vm._v(" "),
      _c("h2", [
...
var update = __webpack_require__("./node_modules/vue-style-loader/lib/addStylesClient.js")("cb605db8", content, false, {});
