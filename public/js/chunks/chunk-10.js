webpackJsonp([10], {
    /***/ './node_modules/babel-loader/lib/index.js?{"cacheDirectory":true,"presets":[["env",{"modules":false,"targets":{"browsers":["> 2%"],"uglify":true}}]],"plugins":["transform-object-rest-spread",["transform-runtime",{"polyfill":false,"helpers":false}],"syntax-dynamic-import"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/views/Events.vue': /***/ function(
        module,
        __webpack_exports__,
        __webpack_require__,
    ) {
        ...
        /* harmony default export */ __webpack_exports__['default'] = {
            ...
            methods: _extends(
                ...
                Object(__WEBPACK_IMPORTED_MODULE_3_vuex__['mapActions'])(
                    service.name,
                    ['selectEvent', 'selectSubEvent', 'selectInvitation'],
                ),
                {
                    eventsGotoPage: function eventsGotoPage(page) {
                        this.gotoPage(
                            page,
                            'events',
                            this.events.data.links.pagination,
                        )
                    },
                    ...
                    downloadInvitation: function downloadInvitation(
                        invitation,
                    ) {
                    ...
                    finalizeSubEventReconfirmed: function finalizeSubEventReconfirmed(
                        subEvent,
                    ) {
                        var _this9 = this
                    ...
                    downloadSubEventPDF: function downloadSubEventPDF(
                        subEvent,
                    ) {
                        var _this12 = this
                    ...
                    canSendEmail: function canSendEmail(invitation) {
                        return (
                            invitation.has_email &&
                            invitation.sub_event.confirmed_at
                        )
                    },
                    replicateCommonInfo: function replicateCommonInfo(
                        subEvent,
                    ) {
                        var _this13 = this
                        ...
                        confirm(
                            ...
                            confirm('CERTEZA ABSOLUTA?', _this13).then(function(
                                value,
                            ) {
                                if (value) {
                                    subEvent.busy = true

                                    return _this13.$store
                                        .dispatch(
                    ...
                    filterNotificationsReceived: function filterNotificationsReceived(
                        notifications,
                        type,
                    ) {
                        return _.filter(
            ...
            computed: {
                ...
                subEventsPerPage: {
                    get: function get() {
                        return this.$store.state['subEvents'].data.links
                            .pagination.per_page
                    },
                    set: function set(perPage) {
                        return this.$store.dispatch(
                ...
                hasNoEmailCheckbox: {
                    get: function get() {
                        return this.$store.state['invitations'].data.filter
                            .checkboxes.hasNoEmail
                    },
                    set: function set(filter) {
                ...
                credentialsReceivedCheckbox: {
                    get: function get() {
                        return this.$store.state['invitations'].data.filter
                            .checkboxes.credentialsReceived
                    },
                    set: function set(filter) {
                        this.$store.commit('invitations/mutateFilterCheckbox', {
                ...
                credentialsNotReceivedCheckbox: {
                    get: function get() {
                        return this.$store.state['invitations'].data.filter
                            .checkboxes.credentialsNotReceived
                    },
                    set: function set(filter) {
                        this.$store.commit('invitations/mutateFilterCheckbox', {
                ...
                invitationsPerPage: {
                    get: function get() {
                        return this.$store.state['invitations'].data.links
                            .pagination.per_page
                    },
                    set: function set(perPage) {
                        return this.$store.dispatch(
    ...
    /***/ './node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{"vue":true,"id":"data-v-1b973310","scoped":false,"hasInlineConfig":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/js/views/Events.vue': /***/ function(
        module,
        exports,
        __webpack_require__,
    ) {
    ...
    /***/ './node_modules/vue-loader/lib/template-compiler/index.js?{"id":"data-v-1b973310","hasScoped":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/views/Events.vue': /***/ function(
        module,
        exports,
        __webpack_require__,
    ) {
                                                                  ...
                                                                  [
                                                                          ...
                                                                          ? _c(
                                                                                'button',
                                                                                {
                                                                                    ...
                                                                                    attrs: {
                                                                                        ...
                                                                                        title:
                                                                                            'Finalizar Sub-evento',
                                                                                    },
                                                                                    on: {
                                                                                        click: function(
                                                                                            $event,
                                                                                        ) {
                                                                                            _vm.finalizeSubEvent(
                                                                                                subEvent,
                                                                                            )
                                                                                        },
                                                                                    },
                                                                      ...
                                                                      _c(
                                                                          'button',
                                                                          {
                                                                              ...
                                                                              attrs: {
                                                                                  title:
                                                                                      'Imprimir lista de convidados',
                                                                              },
                                                                              on: {
                                                                                  click: function(
                                                                                      $event,
                                                                                  ) {
                                                                                      _vm.downloadSubEventPDF(
                                                                                          subEvent,
                                                                                      )
                                                                                  },
                                                                              },
                                      ...
                                      ? _c(
                                            'app-table-panel',
                                            {
                                                attrs: {
                                                    ...
                                                    'per-page':
                                                        _vm.invitationsPerPage,
                                                    'filter-text':
                                                        _vm.invitationsFilterText,
                                                    'dont-center-filters':
                                                        'true',
                                                },
                                                on: {
                                                    'set-per-page': function(
                                                        $event,
                                                    ) {
                                                                    ...
                                                                    [
                                                                        ...
                                                                        _c(
                                                                            'app-input',
                                                                            {
                                                                                ...
                                                                                model: {
                                                                                    value:
                                                                                        _vm.credentialsNotSentCheckbox,
                                                                                    callback: function(
                                                                                        $$v,
                                                                                    ) {
                                                                    ...
                                                                    [
                                                                        _c(
                                                                            'app-input',
                                                                            {
                                                                                ...
                                                                                model: {
                                                                                    value:
                                                                                        _vm.credentialsReceivedCheckbox,
                                                                                    callback: function(
                                                                                        $$v,
                                                                                    ) {
                                                                        ...
                                                                        _c(
                                                                            'app-input',
                                                                            {
                                                                                ...
                                                                                model: {
                                                                                    value:
                                                                                        _vm.credentialsNotReceivedCheckbox,
                                                                                    callback: function(
                                                                                        $$v,
                                                                                    ) {
                                                                            ...
                                                                            invitation.accepted_at
                                                                                ? _c(
                                                                                      'button',
                                                                                      {
                                                                                          ...
                                                                                          attrs: {
                                                                                              title:
                                                                                                  'Baixar PDF das credenciais',
                                                                                          },
                                                                                          on: {
                                                                                              click: function(
                                                                                                  $event,
                                                                                              ) {
                                                                                                  _vm.downloadInvitation(
                                                                                                      invitation,
                                                                                                  )
                                                                                              },
                                                                                          },
    ...
    /***/ './node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{"vue":true,"id":"data-v-1b973310","scoped":false,"hasInlineConfig":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/js/views/Events.vue': /***/ function(
        module,
        exports,
        __webpack_require__,
    ) {
        ...
        )('40b1c132', content, false, {})
        // Hot Module Replacement
        if (false) {
            // When the styles change, update the <style> tags
            if (!content.locals) {
                module.hot.accept(
                    '!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{"vue":true,"id":"data-v-1b973310","scoped":false,"hasInlineConfig":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Events.vue',
                    function() {
    ...
    /***/ './resources/js/views/Events.vue': /***/ function(
        module,
        exports,
        __webpack_require__,
    ) {
