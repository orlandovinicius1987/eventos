webpackJsonp([7], {
    /***/ './node_modules/babel-loader/lib/index.js?{"cacheDirectory":true,"presets":[["env",{"modules":false,"targets":{"browsers":["> 2%"],"uglify":true}}]],"plugins":["transform-object-rest-spread",["transform-runtime",{"polyfill":false,"helpers":false}],"syntax-dynamic-import"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/js/views/People.vue': /***/ function(
        module,
        __webpack_exports__,
        __webpack_require__,
    ) {
        ...
        /* harmony default export */ __webpack_exports__['default'] = {
                ...
                ),
                {
                    peopleGotoPage: function peopleGotoPage(page) {
                        this.gotoPage(
                            page,
                            'people',
                            this.people.data.links.pagination,
                        )
                    },
                    personInstitutionsGotoPage: function personInstitutionsGotoPage(
                        page,
                    ) {
                        this.gotoPage(
                            page,
                    ...
                    advisorContactsGotoPage: function advisorContactsGotoPage(
                        page,
                    ) {
                        this.gotoPage(
                            page,
                    ...
                    personCategoriesGotoPage: function personCategoriesGotoPage(
                        page,
                    ) {
                        this.gotoPage(
                            page,
                    ...
                    confirmDeletePersonCategory: function confirmDeletePersonCategory(
                        personCategory,
                    ) {
                        var _this = this
                    ...
                    deletePersonCategory: function deletePersonCategory(
                        personCategory,
                    ) {
            ...
            computed: {
                ...
                personInstitutionsFilterText: {
                    get: function get() {
                        return this.$store.state['personInstitutions'].data
                            .filter.text
                    },
                    set: function set(filter) {
                        return this.$store.dispatch(
                ...
                addressesPerPage: {
                    get: function get() {
                        return this.$store.state['addresses'].data.links
                            .pagination.per_page
                    },
                    set: function set(perPage) {
                        return this.$store.dispatch(
                            'addresses/setPerPage',
                            perPage,
                        )
                    },
                },
                ...
                contactsPerPage: {
                    get: function get() {
                        return this.$store.state['contacts'].data.links
                            .pagination.per_page
                    },
                    set: function set(perPage) {
                        return this.$store.dispatch(
                ...
                personCategoriesFilterText: {
                    get: function get() {
                        return this.$store.state['personCategories'].data.filter
                            .text
                    },
                    set: function set(filter) {
                        return this.$store.dispatch(
                ...
                advisorsPerPage: {
                    get: function get() {
                        return this.$store.state['advisors'].data.links
                            .pagination.per_page
                    },
                    set: function set(perPage) {
                        return this.$store.dispatch(
                ...
                advisorContactsFilterText: {
                    get: function get() {
                        return this.$store.state['advisorContacts'].data.filter
                            .text
                    },
                    set: function set(filter) {
                        return this.$store.dispatch(
                ...
                hasNoPhotoCheckbox: {
                    get: function get() {
                        return this.$store.state['people'].data.filter
                            .checkboxes.hasNoPhoto
                    },
                    set: function set(filter) {
    ...
    /***/ './node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{"vue":true,"id":"data-v-02fd0cee","scoped":false,"hasInlineConfig":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/js/views/People.vue': /***/ function(
        module,
        exports,
        __webpack_require__,
    ) {
    ...
    /***/ './node_modules/vue-loader/lib/template-compiler/index.js?{"id":"data-v-02fd0cee","hasScoped":false,"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./resources/js/views/People.vue': /***/ function(
        module,
        exports,
        __webpack_require__,
    ) {
                                        ...
                                        ? _c(
                                              'app-table-panel',
                                              {
                                                  attrs: {
                                                      ...
                                                      'per-page':
                                                          _vm.personCategoriesPerPage,
                                                      'filter-text':
                                                          _vm.personCategoriesFilterText,
                                                  },
                                                  on: {
                                                      ...
                                                      'app-table',
                                                      {
                                                          ...
                                                          on: {
                                                              'goto-page': function(
                                                                  ...
                                                                  _vm.personInstitutionsGotoPage(
                                                                      $event,
                                                                  )
                                                              },
                                                          },
                                        ...
                                        ? _c(
                                              'app-table-panel',
                                              {
                                                  attrs: {
                                                      ...
                                                      'per-page':
                                                          _vm.addressesPerPage,
                                                      'filter-text':
                                                          _vm.addressesFilterText,
                                                  },
                                                  on: {
                                                      'set-per-page': function(
                                                          $event,
                                        ...
                                        ? _c(
                                              'app-table-panel',
                                              {
                                                  attrs: {
                                                      ...
                                                      'per-page':
                                                          _vm.advisorContactsPerPage,
                                                      'filter-text':
                                                          _vm.advisorContactsFilterText,
                                                  },
                                                  on: {
                                                      'set-per-page': function(
                                                          $event,
    ...
    /***/ './node_modules/vue-style-loader/index.js!./node_modules/css-loader/index.js!./node_modules/vue-loader/lib/style-compiler/index.js?{"vue":true,"id":"data-v-02fd0cee","scoped":false,"hasInlineConfig":true}!./node_modules/vue-loader/lib/selector.js?type=styles&index=0!./resources/js/views/People.vue': /***/ function(
        module,
        exports,
        __webpack_require__,
    ) {
        ...
        )('8737124e', content, false, {})
        // Hot Module Replacement
        if (false) {
            // When the styles change, update the <style> tags
            if (!content.locals) {
                module.hot.accept(
                    '!!../../../node_modules/css-loader/index.js!../../../node_modules/vue-loader/lib/style-compiler/index.js?{"vue":true,"id":"data-v-02fd0cee","scoped":false,"hasInlineConfig":true}!../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./People.vue',
                    function() {
    ...
    /***/ './resources/js/views/People.vue': /***/ function(
        module,
        exports,
        __webpack_require__,
    ) {
