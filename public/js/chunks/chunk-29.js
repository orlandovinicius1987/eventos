webpackJsonp([29], {
    /***/ './node_modules/vue-croppa/dist/vue-croppa.js': /***/ function(
        module,
        exports,
        __webpack_require__,
    ) {
        /* WEBPACK VAR INJECTION */ ;(function(global) {
            ...
            ;(function(global, factory) {
                ...
                var canvasExifOrientation = createCommonjsModule(function(
                    module,
                    exports,
                ) {
                ...
                var u = {
                            ...
                            Object.defineProperty(
                                ...
                                'toBlob',
                                {
                                    value: function value(
                                        ...
                                        binStr = atob(
                                            this.toDataURL(type, quality).split(
                                                ',',
                                            )[1],
                                        )
                                        len = binStr.length
                    ...
                    getFileOrientation: function getFileOrientation(
                        arrayBuffer,
                    ) {
                    ...
                    getRotatedImage: function getRotatedImage(
                        img,
                        orientation,
                    ) {
                        var _canvas = canvasExifOrientation.drawImage(
                            img,
                            orientation,
                        )
                        var _img = new Image()
                ...
                var component = {
                    render: function render() {
                        ...
                        return _c(
                            'div',
                            {
                                ...
                                class:
                                    'croppa-container ' +
                                    (_vm.img ? 'croppa--has-target' : '') +
                                    ' ' +
                                    (_vm.passive ? 'croppa--passive' : '') +
                                    ' ' +
                                    (_vm.disabled ? 'croppa--disabled' : '') +
                                    ' ' +
                                    (_vm.disableClickToChoose
                                        ? 'croppa--disabled-cc'
                                        : '') +
                                    ' ' +
                                    (_vm.disableDragToMove &&
                                    _vm.disableScrollToZoom
                                        ? 'croppa--disabled-mz'
                                        : '') +
                                    ' ' +
                                    (_vm.fileDraggedOver
                                ...
                                on: {
                                    dragenter: function dragenter($event) {
                                        ...
                                        return _vm._handleDragEnter($event)
                                    },
                                    dragleave: function dragleave($event) {
                                        $event.stopPropagation()
                                        $event.preventDefault()
                                        return _vm._handleDragLeave($event)
                                    },
                                    dragover: function dragover($event) {
                                        $event.stopPropagation()
                                        $event.preventDefault()
                                        return _vm._handleDragOver($event)
                                    },
                                    drop: function drop($event) {
                                        $event.stopPropagation()
                                        $event.preventDefault()
                                        return _vm._handleDrop($event)
                                    },
                                },
                            },
                            [
                                ...
                                _c('canvas', {
                                    ...
                                    on: {
                                        click: function click($event) {
                                            $event.stopPropagation()
                                            $event.preventDefault()
                                            return _vm._handleClick($event)
                                        },
                                        dblclick: function dblclick($event) {
                                            $event.stopPropagation()
                                            $event.preventDefault()
                                            return _vm._handleDblClick($event)
                                        },
                                        touchstart: function touchstart(
                                            $event,
                                        ) {
                                            $event.stopPropagation()
                                            return _vm._handlePointerStart(
                                                $event,
                                            )
                                        },
                                        ...
                                        pointerstart: function pointerstart(
                                            $event,
                                        ) {
                                            $event.stopPropagation()
                                            $event.preventDefault()
                                        ...
                                        touchend: function touchend($event) {
                                            $event.stopPropagation()
                                            $event.preventDefault()
                                            return _vm._handlePointerEnd($event)
                                        },
                                        ...
                                        pointerend: function pointerend(
                                            $event,
                                        ) {
                                            $event.stopPropagation()
                                            $event.preventDefault()
                                        ...
                                        pointerleave: function pointerleave(
                                            ...
                                            $event.stopPropagation()
                                            $event.preventDefault()
                                            return _vm._handlePointerLeave(
                                                $event,
                                            )
                                        },
                                        DOMMouseScroll: function DOMMouseScroll(
                                            $event,
                                        ) {
                                            $event.stopPropagation()
                                            return _vm._handleWheel($event)
                                        },
                                ...
                                _vm._v(' '),
                                _vm.showRemoveButton && _vm.img && !_vm.passive
                                    ? _c(
                                          'svg',
                                          {
                    ...
                    computed: {
                        outputWidth: function outputWidth() {
                            var w = this.useAutoSizing
                                ? this.realWidth
                                : this.width
                            return w * this.quality
                        },
                        outputHeight: function outputHeight() {
                            var h = this.useAutoSizing
                                ? this.realHeight
                                : this.height
                    ...
                    watch: {
                        ...
                        scaleRatio: function scaleRatio(val, oldVal) {
                            ...
                            if (
                                ...
                                var offsetX =
                                    (x - 1) * (pos.x - this.imgData.startX)
                                var offsetY =
                                    (x - 1) * (pos.y - this.imgData.startY)
                                this.imgData.startX =
                    ...
                    methods: {
                        ...
                        getChosenFile: function getChosenFile() {
                            return (
                                this.chosenFile || this.$refs.fileInput.files[0]
                            )
                        },
                        move: function move(offset) {
                            ...
                            if (
                                this.imgData.startX !== oldX ||
                                this.imgData.startY !== oldY
                            ) {
                        ...
                        zoom: function zoom() {
                            ...
                            var speed =
                                this.outputWidth * PCT_PER_ZOOM * realSpeed
                            var x = 1
                            if (zoomIn) {
                                x = 1 + speed
                        ...
                        applyMetadata: function applyMetadata(metadata) {
                            ...
                            var ori =
                                metadata.orientation || this.orientation || 1
                        ...
                        _setInitial: function _setInitial() {
                            ...
                            if (
                                this.initialImage &&
                                typeof this.initialImage === 'string'
                            ) {
                                ...
                                _typeof(this.initialImage) === 'object' &&
                        ...
                        _onload: function _onload(img) {
                            ...
                            if (initial) {
                                this.emitEvent(
                                    events.INITIAL_IMAGE_LOADED_EVENT,
                                )
                            }
                        },
                        ...
                        _onNewFileIn: function _onNewFileIn(file) {
                            ...
                            if (!this._fileTypeIsValid(file)) {
                                this.loading = false
                                this.emitEvent(
                                    events.FILE_TYPE_MISMATCH_EVENT,
                                    file,
                                )
                                var type =
                                    file.type ||
                            ...
                            if (
                                ...
                                fr.onload = function(e) {
                                    ...
                                    if (isVideo) {
                                        ...
                                        var orientation = 1
                                        try {
                                            orientation = u.getFileOrientation(
                        ...
                        _fileTypeIsValid: function _fileTypeIsValid(file) {
                            var acceptableMimeType =
                                (this.videoEnabled &&
                                    /^video/.test(file.type) &&
                                    document
                                        .createElement('video')
                                        .canPlayType(file.type)) ||
                        ...
                        _placeImage: function _placeImage(applyMetadata) {
                            ...
                            imgData.startX = u.numberValid(imgData.startX)
                                ? imgData.startX
                                : 0
                            imgData.startY = u.numberValid(imgData.startY)
                                ? imgData.startY
                                : 0
                            ...
                            if (this.preventWhiteSpace) {
                                ...
                                this.imgData.width =
                                    this.naturalWidth * this.scaleRatio
                                this.imgData.height =
                                    this.naturalHeight * this.scaleRatio
                            }
                            ...
                            if (!this.imageSet) {
                                if (/top/.test(this.initialPosition)) {
                                    ...
                                    /bottom/.test(this.initialPosition)
                                ) {
                                    imgData.startY =
                                        this.outputHeight - imgData.height
                                }
                                ...
                                if (/left/.test(this.initialPosition)) {
                                    ...
                                    imgData.startX =
                                        this.outputWidth - imgData.width
                                }

                                if (
                                    /^-?\d+% -?\d+%$/.test(this.initialPosition)
                                ) {
                                    var result = /^(-?\d+)% (-?\d+)%$/.exec(
                                    ...
                                    var y = +result[2] / 100
                                    imgData.startX =
                                        x * (this.outputWidth - imgData.width)
                                    imgData.startY =
                                        y * (this.outputHeight - imgData.height)
                                }
                            }
                        ...
                        _aspectFill: function _aspectFill() {
                            ...
                            if (this.aspectRatio > canvasRatio) {
                                ...
                                this.imgData.startX =
                                    -(this.imgData.width - this.outputWidth) / 2
                        ...
                        _naturalSize: function _naturalSize() {
                            ...
                            this.imgData.startX =
                                -(this.imgData.width - this.outputWidth) / 2
                            this.imgData.startY =
                                -(this.imgData.height - this.outputHeight) / 2
                        },
                        _handlePointerStart: function _handlePointerStart(evt) {
                            ...
                            if (
                                ...
                                this.dragging = false
                                this.pinching = true
                                this.pinchDistance = u.getPinchDistance(
                                    evt,
                                    this,
                                )
                            }
                            ...
                            for (
                                var i = 0, len = cancelEvents.length;
                                i < len;
                                i++
                            ) {
                            ...
                            if (this.pointerStartCoord) {
                                ...
                                pointerMoveDistance =
                                    Math.sqrt(
                                        Math.pow(
                                            pointerCoord.x -
                                                this.pointerStartCoord.x,
                                            2,
                                        ) +
                                            Math.pow(
                                                pointerCoord.y -
                                                    this.pointerStartCoord.y,
                                                2,
                                            ),
                                    ) || 0
                            }
                        ...
                        _handleDragLeave: function _handleDragLeave(evt) {
                            this.emitNativeEvent(evt)
                            if (this.passive) return
                            if (!this.fileDraggedOver || !u.eventHasFile(evt))
                                return
                        ...
                        _setOrientation: function _setOrientation() {
                            ...
                            if (orientation == 2) {
                                ...
                                // 180 deg
                                this.orientation = u.rotate90(
                                    u.rotate90(this.orientation),
                                )
                            } else if (orientation == 8) {
                                // 270 deg
                                this.orientation = u.rotate90(
                                    u.rotate90(u.rotate90(this.orientation)),
                                )
                            } else {
                        ...
                        _clipPathFactory: function _clipPathFactory(
                            x,
                            y,
                            width,
                            height,
